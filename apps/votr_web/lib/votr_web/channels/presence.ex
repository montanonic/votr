defmodule VotrWeb.Presence do
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule VotrWeb.MyChannel do
        use VotrWebWeb, :channel
        alias VotrWebWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :votr_web,
                        pubsub_server: VotrWeb.PubSub
end
